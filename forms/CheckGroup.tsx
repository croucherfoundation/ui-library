...
const CheckGroup: React.FC<CheckGroupProps> = ({ label, name, options, isYesOnly }) => {
          ...
          <ul className="overflow-y-auto flex">
            {
              options.map((option, index) => (
                <li
                  className="py-1 flex justify-start items-center gap-2 cursor-pointer w-[20%]"
                  key={"check_" + index}
          ...
          <ul className="overflow-y-auto">
            {
              options.map((option, index) => (
                <div key={index}>
                  <li
                    className={[
                      "py-1 flex justify-start items-center gap-2 cursor-pointer w-full",
